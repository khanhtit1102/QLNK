...
<head>
    ...
    <title>NHK Bắc Ninh - Thêm thông tin hộ khẩu mới</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Thêm hộ khẩu mới</h4>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                	<div class="col-12 mt-5">
                		<div class="card">
                			<div class="card-body">
                                <div class="alert alert-warning" role="alert"><strong>LƯU Ý! </strong>Vui lòng điền đầy đủ thông tin và chính xác!</div>
                                <div class="noti">
                                    <p style="color: red;">
