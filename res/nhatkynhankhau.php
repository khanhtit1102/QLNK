...
<head>
    ...
    <title>NHK Bắc Ninh - Nhật ký nhân khẩu</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Nhật ký nhân khẩu</h4>
                        </div>
                    </div>
                					...
                					<table id="dataTable" class="text-center table-hover">
                						...
                						<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value['tg']; ?></td>
                                                <td><?php echo $value['dc']; ?></td>
                                                <td><?php echo $value['trinhdonn']; ?></td>
                                                <td><?php echo $value['noilamviec']; ?></td>
                                                <td><?php echo $value['choohiennay']; ?></td>
                                                <td><?php echo $value['quequan']; ?></td>
                                                <td><?php echo $value['tdhocvan']; ?></td>
