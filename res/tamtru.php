...
<head>
    ...
    <title>NHK Bắc Ninh - Quản lý tạm trú</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Quản lý tạm trú</h4>
                        </div>
                    </div>
                						...
                						<tbody>
                							...
                							<tr>
                								...
                								<td>
                									...
                									<a href="<?php echo base_url('admin/xoatamtru/').$value['id']; ?>" class="btn btn-danger" style="padding: .375rem .75rem;" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><i class="fa fa-trash"></i></a>
                								</td>
                							</tr>
                                            <?php } ?>
                						</tbody>
