...
<head>
    ...
    <title>NHK Bắc Ninh - Sửa thông tin chuyển khẩu</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Sửa thông tin chuyển khẩu</b></u></h4>
                        </div>
                    </div>
                		...
                		<div class="card">
                			<div class="card-body">
                                ...
                                <form action="" method="post">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select name="khaumoi" id="khaumoi" class="form-control">
                                                    ...
                                                    <option value="<?php echo $row['mahk'] ?>" <?php if ($row['mahk'] == $value['khaumoi']) { echo ' selected=""'; } ?>><?php echo $row['mahk'].' - '.$row['tench'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn btn-rounded btn-info" name="edit" value="submit" type="submit">Xác nhận thêm</button>
                                </form>
                                <?php } ?>
                			</div>
                		</div>
